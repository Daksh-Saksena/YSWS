...
# Replace the old position style with width/height 100%
grid_html = re.sub(
...
# Remove the grid from its original location
content = content.replace(match.group(1), '')

# 2. Insert the grid into image-container
...
# 3. Remove the syncGrid function
