| title | How It Works |
| description | The full flow to funding |
| --- | --- |

# How It Works

trek will fund as much as you need to build any hardware project! Here's how:

## 1. Start a new project!

On the website:
Create a new project and then Fill in all the details - you can always edit this later! Now it's time to start designing.
...
Journal entries are how you track your time & progress in Trek. They usually contain what you did during that work session, some interesting things you noticed, and a few images!
