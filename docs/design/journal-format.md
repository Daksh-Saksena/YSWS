...
1. **On Trek** -> Add devlog entries directly on your project page (click "New Entry")
...
After pushing your `JOURNAL.md` to GitHub, go to your project page on Trek and click **"Sync JOURNAL.md"**. New entries will be imported (existing ones are skipped based on title).
